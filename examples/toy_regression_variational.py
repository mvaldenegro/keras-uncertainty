...
from keras_uncertainty.layers import VariationalDense
...
def mlp_model(num_batches, prior_params):
    ...
    x = VariationalDense(16, kl_weight, activation="relu", **prior_params)(inp)
    x = VariationalDense(16, kl_weight, activation="relu", **prior_params)(x)
    #x = VariationalDense(16, kl_weight, activation="relu", **prior_params)(x)

    out = VariationalDense(1, kl_weight, **prior_params)(x)
    model = Model(inp, out)
